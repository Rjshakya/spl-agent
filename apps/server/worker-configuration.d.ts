/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 65fe8e08511b80872f54a75e9c3cf70b)
...
declare namespace Cloudflare {
	...
	interface Env {
		SQL_AGENT_KV: KVNamespace;
		HYPERDRIVE_DEV: Hyperdrive;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPEN_ROUTER_API_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DATABASE_URL" | "DATABASE_URL_LOCAL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "CLIENT_URL" | "DOMAIN">> {}
}
